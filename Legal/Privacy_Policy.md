...
This privacy policy applies to the Guide, Checklist - AC Shadows app (hereinafter referred to as "Application") for mobile devices, created by Developer Mahak Aggarwal (MMagg) (hereinafter referred to as "Service Provider") as an Ad-Supported service. This service is intended for use "AS IS".
...
The Service Provider may use the information you provided to contact you from time to time to provide you with important information. For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to Email and User ID. The information that the Service Provider requests will be retained by them and used as described in this privacy policy.
...
*   with their trusted service providers who work on their behalf, do not have independent use of the information we disclose to them, and have agreed to adhere to the rules outlined in this privacy statement.
